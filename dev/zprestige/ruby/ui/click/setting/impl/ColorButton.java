...
public class ColorButton extends Button
{
    ...
    public ColorButton(final ColorBox setting) {
    ...
    public static void drawLeftGradientRect(final int left, final int top, final int right, final int bottom, final int startColor, final int endColor) {
        ...
        ColorButton.builder.begin(7, DefaultVertexFormats.POSITION_COLOR);
        ColorButton.builder.pos((double)right, (double)top, 0.0).color((endColor >> 24 & 0xFF) / 255.0f, (endColor >> 16 & 0xFF) / 255.0f, (endColor >> 8 & 0xFF) / 255.0f, (endColor >> 24 & 0xFF) / 255.0f).endVertex();
        ColorButton.builder.pos((double)left, (double)top, 0.0).color((startColor >> 16 & 0xFF) / 255.0f, (startColor >> 8 & 0xFF) / 255.0f, (startColor & 0xFF) / 255.0f, (startColor >> 24 & 0xFF) / 255.0f).endVertex();
        ColorButton.builder.pos((double)left, (double)bottom, 0.0).color((startColor >> 16 & 0xFF) / 255.0f, (startColor >> 8 & 0xFF) / 255.0f, (startColor & 0xFF) / 255.0f, (startColor >> 24 & 0xFF) / 255.0f).endVertex();
        ColorButton.builder.pos((double)right, (double)bottom, 0.0).color((endColor >> 24 & 0xFF) / 255.0f, (endColor >> 16 & 0xFF) / 255.0f, (endColor >> 8 & 0xFF) / 255.0f, (endColor >> 24 & 0xFF) / 255.0f).endVertex();
        ColorButton.tessellator.draw();
    ...
    public void render(final int mouseX, final int mouseY) {
        ...
        RenderUtil.drawRect((float)(this.x + this.width - 10), (float)(this.y + 3), (float)(this.x + this.width - 3), (float)(this.y + this.height - 3), this.color.GetColor().getRGB());
        RenderUtil.drawOutlineRect(this.x + this.width - 10, this.y + 3, this.x + this.width - 3, this.y + this.height - 3, ClickGui.Instance.color.GetColor(), 1.0f);
        if (this.opened) {
            GL11.glPushMatrix();
            ...
            this.color.setValue(this.finalColor);
            GL11.glDisable(3089);
            GL11.glPopAttrib();
            GL11.glPopMatrix();
        }
    ...
    public void pasteClipBoard() {
        ...
        try {
            ...
            this.color.setValue(new Color(Integer.parseInt(color1[0]), Integer.parseInt(color1[1]), Integer.parseInt(color1[2]), Integer.parseInt(color1[3])));
    ...
    public void drawPicker(final ColorBox setting, final int pickerX, final int pickerY, final int hueSliderX, final int hueSliderY, final int alphaSliderX, final int alphaSliderY, final int mouseX, final int mouseY) {
    ...
    static {
        ColorButton.tessellator = Tessellator.getInstance();
        ColorButton.builder = ColorButton.tessellator.getBuffer();
    }
}
